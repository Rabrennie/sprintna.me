/*
  ...
  - Added the required column `invite` to the `Team` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Choice" ("albumArtist", "albumId", "albumImage", "albumName", "createdAt", "eliminated", "id", "roomId", "userId") SELECT "albumArtist", "albumId", "albumImage", "albumName", "createdAt", "eliminated", "id", "roomId", "userId" FROM "Choice";
DROP TABLE "Choice";
